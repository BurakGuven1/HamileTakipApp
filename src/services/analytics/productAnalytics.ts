...
export type AnalyticsEventName =
  ...
  | "paywall_requested"
  | "photo_deleted"
  | "photo_studio_exported"
  | "photo_studio_opened"
  | "photo_studio_photo_selected"
  | "photo_uploaded"
  ...
  | "document_insight_red_flag_shown"
  | "document_insight_result_engaged"
  | "document_insight_result_viewed"
  | "contraction_pattern_reached_rule"
  | "contraction_started"
  | "contraction_stopped"
  | "intro_trial_ended"
